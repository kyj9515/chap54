...
// 	let reds = document.querySelectorAll("input[value='red']");
// 	reds.forEach(function(elt, i, array) {
// 		elt.onchange = function() {
// 			let red = elt.parentElement.nextElementSibling;
// 			if (elt.checked) {
...
// 	let blues = document.querySelectorAll("input[value='blue']");
// 	blues.forEach(function(elt, i, array) {
// 		elt.onchange = function() {
// 			let blue = elt.parentElement.nextElementSibling;
// 			if (elt.checked) {
...
// 	let greens = document.querySelectorAll("input[value='green']");
// 	greens.forEach(function(elt, i, array) {
// 		elt.onchange = function() {
// 			let green = elt.parentElement.nextElementSibling;
// 			if (elt.checked) {
